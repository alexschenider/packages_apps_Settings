...
import com.xtended.xtensions.fragments.AlarmBlocker;
import com.xtended.xtensions.fragments.AnimSettings;
import com.xtended.xtensions.fragments.BatteryBarSettings;
import com.xtended.xtensions.fragments.ButtonSettings;
import com.xtended.xtensions.fragments.CarbonGesturesSettings;
import com.xtended.xtensions.fragments.CarrierLabelSettings;
import com.xtended.xtensions.fragments.DecorRoomSettings;
import com.xtended.xtensions.fragments.FlingSettings;
import com.xtended.xtensions.fragments.GestureSettings;
import com.xtended.xtensions.fragments.LockScreenSettings;
import com.xtended.xtensions.fragments.LockScreenUi;
import com.xtended.xtensions.fragments.MiscSettings;
import com.xtended.xtensions.fragments.NavbarSettings;
import com.xtended.xtensions.fragments.NotificationSettings;
import com.xtended.xtensions.fragments.PowerMenuSettings;
import com.xtended.xtensions.fragments.PulseSettings;
import com.xtended.xtensions.fragments.QuickSettings;
import com.xtended.xtensions.fragments.RecentsSettings;
import com.xtended.xtensions.fragments.SmartPixels;
import com.xtended.xtensions.fragments.StatusBarBattery;
import com.xtended.xtensions.fragments.StatusBarClockSettings;
...
public final class SearchIndexableResources {
    ...
    static {
        ...
        addIndex(AlarmBlocker.class, NO_DATA_RES_ID, R.drawable.ic_settings_event_service);
        addIndex(AnimSettings.class, NO_DATA_RES_ID, R.drawable.ic_settings_event_service);
        addIndex(BatteryBarSettings.class, NO_DATA_RES_ID, R.drawable.ic_settings_event_service);
        addIndex(ButtonSettings.class, NO_DATA_RES_ID, R.drawable.ic_settings_event_service);
        addIndex(CarbonGesturesSettings.class, NO_DATA_RES_ID, R.drawable.ic_settings_event_service);
        addIndex(CarrierLabelSettings.class, NO_DATA_RES_ID, R.drawable.ic_settings_event_service);
        addIndex(DecorRoomSettings.class, NO_DATA_RES_ID, R.drawable.ic_settings_event_service);
        addIndex(FlingSettings.class, NO_DATA_RES_ID, R.drawable.ic_settings_event_service);
        addIndex(LockScreenSettings.class, NO_DATA_RES_ID, R.drawable.ic_settings_event_service);
        addIndex(LockScreenUi.class, NO_DATA_RES_ID, R.drawable.ic_settings_event_service);
        addIndex(MiscSettings.class, NO_DATA_RES_ID, R.drawable.ic_settings_event_service);
        addIndex(NavbarSettings.class, NO_DATA_RES_ID, R.drawable.ic_settings_event_service);
        addIndex(NotificationSettings.class, NO_DATA_RES_ID, R.drawable.ic_settings_event_service);
        addIndex(PowerMenuSettings.class, NO_DATA_RES_ID, R.drawable.ic_settings_event_service);
        addIndex(PulseSettings.class, NO_DATA_RES_ID, R.drawable.ic_settings_event_service);
        addIndex(QuickSettings.class, NO_DATA_RES_ID, R.drawable.ic_settings_event_service);
        addIndex(RecentsSettings.class, NO_DATA_RES_ID, R.drawable.ic_settings_event_service);
        addIndex(SmartPixels.class, NO_DATA_RES_ID, R.drawable.ic_settings_event_service);
        addIndex(StatusBarBattery.class, NO_DATA_RES_ID, R.drawable.ic_settings_event_service);
        addIndex(StatusBarClockSettings.class, NO_DATA_RES_ID, R.drawable.ic_settings_event_service);
        addIndex(SuspendActions.class, NO_DATA_RES_ID, R.drawable.ic_settings_event_service);
